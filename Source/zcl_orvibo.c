...
static void zclOrvibo_ProcessIdentifyTimeChange( uint8 endpoint );
static void zclOrvibo_BindNotification( bdbBindNotificationData_t *data );
...
void zclOrvibo_Init( byte task_id )
{
  ...
  bdb_RegisterIdentifyTimeChangeCB( zclOrvibo_ProcessIdentifyTimeChange );
  bdb_RegisterBindNotificationCB( zclOrvibo_BindNotification );
...
uint16 zclOrvibo_event_loop( uint8 task_id, uint16 events )
{
  ...
  /* ORVIBO_TODO: handle app events here */
  
  
    /*
  if ( events & ORVIBO_EVT_2 )
  {
    
    return ( events ^ ORVIBO_EVT_2 );
  }
  
  if ( events & ORVIBO_EVT_3 )
  {
    
    return ( events ^ ORVIBO_EVT_3 );
  }
  */
...
/*********************************************************************
 * @fn      zclOrvibo_ProcessIdentifyTimeChange
 *
...
static void zclOrvibo_BindNotification( bdbBindNotificationData_t *data )
{
  // ORVIBO_TODO: process the new bind information
}


/*********************************************************************
 * @fn      zclOrvibo_ProcessTouchlinkTargetEnable
 *
...
static void zclOrvibo_BasicResetCB( void )
{
  ...
  /* ORVIBO_TODO: remember to update this function with any
...
/*********************************************************************
 * @fn      zclOrvibo_ProcessIncomingMsg
 *
...
#ifdef ZCL_READ
/*********************************************************************
 * @fn      zclOrvibo_ProcessInReadRspCmd
 *
...
#ifdef ZCL_WRITE
/*********************************************************************
 * @fn      zclOrvibo_ProcessInWriteRspCmd
 *
...
/*********************************************************************
 * @fn      zclOrvibo_ProcessInDefaultRspCmd
 *
...
#ifdef ZCL_DISCOVER
/*********************************************************************
 * @fn      zclOrvibo_ProcessInDiscCmdsRspCmd
 *
...
/*********************************************************************
 * @fn      zclOrvibo_ProcessInDiscAttrsRspCmd
 *
...
/*********************************************************************
 * @fn      zclOrvibo_ProcessInDiscAttrsExtRspCmd
 *
